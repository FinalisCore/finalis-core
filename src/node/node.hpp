...
class Node {
 ...
 private:
  ...
  std::optional<storage::EpochRewardSettlementState> rebuild_frozen_epoch_reward_state_from_finalized_chain_locked(
  ...
  std::set<std::pair<std::uint32_t, std::uint64_t>> quarantined_ingress_records_;
#ifdef _WIN32
  ...
  std::uint64_t last_round0_no_quorum_log_ms_{0};
  ...
  bool prefer_validators_addrman_{false};
