...
TEST(test_lightserver_get_status_exposes_runtime_sync_summary) {
  ...
  ASSERT_TRUE(resp.find("\"advertised_endpoint_present\":true") != std::string::npos);
  ASSERT_TRUE(resp.find("\"advertised_endpoint_likely_public\":true") != std::string::npos);
  ASSERT_TRUE(resp.find("\"advertised_endpoint\":\"198.51.100.8:19440\"") != std::string::npos);
  ASSERT_TRUE(resp.find("\"stun_enabled\":true") != std::string::npos);
  ASSERT_TRUE(resp.find("\"stun_last_success\":true") != std::string::npos);
  ASSERT_TRUE(resp.find("\"stun_last_server\":\"stun.l.google.com:19302\"") != std::string::npos);
  ASSERT_TRUE(resp.find("\"stun_backoff_until_unix_ms\":1234999") != std::string::npos);
  ASSERT_TRUE(resp.find("\"stun_endpoint_change_pending\":true") != std::string::npos);
  ASSERT_TRUE(resp.find("\"stun_endpoint_change_hits\":2") != std::string::npos);
  ASSERT_TRUE(resp.find("\"stun_endpoint_change_required_hits\":3") != std::string::npos);
  ASSERT_TRUE(resp.find("\"stun_endpoint_candidate\":\"198.51.100.9:19440\"") != std::string::npos);
